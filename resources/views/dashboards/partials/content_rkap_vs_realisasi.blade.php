{{-- Pastikan file ini berada di direktori resources/views/ --}}

<div id="rkap-content" data-tab-content="rkap" class="tab-content hidden">
    {{-- Tombol input telah dihapus dari baris ini --}}
    <div class="flex justify-end items-center mb-4">

        <button id="exportRkapButton" class="ml-4 mr-4 bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg">
            Export
        </button>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-x-auto">
        <table class="min-w-full leading-normal">
            <thead>
                {{-- [MODIFIKASI] Mengubah tahun pada header menjadi dinamis --}}
                @php
                $currentYear = date('Y');
            ...
            <tbody id="rkapTableBody" class="text-gray-700 text-sm">
                {{-- Logika looping ini berasumsi controller mengirim data untuk 12 bulan --}}
                ...
                <tr class="rkap-row border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            ...
                            {{-- [MODIFIKASI] Tombol delete sekarang akan mereset data --}}
                            <button data-id="{{ $rkap->id }}" class="delete-rkap-btn w-8 h-8 rounded-full flex items-center justify-center bg-red-500 hover:bg-red-600 text-white" title="Reset Data">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center py-6">Data RKAP belum diinisialisasi. Silakan jalankan seeder.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
