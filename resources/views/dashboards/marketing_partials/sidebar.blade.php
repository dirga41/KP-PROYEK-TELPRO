...
<aside class="w-64 flex flex-col p-6 border-r border-gray-200 bg-white">
    ...
    <nav id="mainNav" class="flex-grow">
        <ul>
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('dashboard.marketing.asset') }}" class="flex items-center p-3 text-gray-600 hover:bg-gray-100 rounded-lg {{ request()->routeIs('dashboard.marketing.asset') ? 'bg-red-100 text-red-700 font-bold' : '' }}">
