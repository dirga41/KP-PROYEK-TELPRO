        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-md bg-white">
            ...
            <form action="{{ route('project-plans.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div><label for="plan_update_info" class="block mb-2 text-sm font-medium text-gray-900">Keterangan</label><textarea name="update_info" id="plan_update_info" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea></div>
                </div>
